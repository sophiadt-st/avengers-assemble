  ...
  return (
    <html lang="en">
      ...
      <body className="bg-hero">
        <nav className="px-2 sm:px-4 bg-black h-14">
          <div className="container pl-0 flex flex-wrap justify-between items-center mx-auto">
            <a href="/" className="flex items-center">
              <HomeLogoFull height="100%" width="135px" className="text-white"/>
            </a>
          </div>
        </nav>
        <main className="container mx-auto bg-white min-h-screen py-4">
          <Outlet />
        </main>
